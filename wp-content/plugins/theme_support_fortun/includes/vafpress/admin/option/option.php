<?php
return array(
    'title' => __( 'Fortune Theme Options', BUNCH_NAME ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => get_template_directory_uri().'/images/favicon/favicon.ico'
                        ),
						array(
							'type' => 'upload',
							'name' => 'logo_image',
						...
						array(
							'type' => 'toggle',
							'name' => 'head_search',
							'label' => __( 'Show / Hide Search Icon', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Search Icon.', BUNCH_NAME)
						),
						array(
							'type' => 'toggle',
							'name' => 'head_cart',
							'label' => __( 'Show / Hide Cart Icon', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Cart Icon.', BUNCH_NAME)
						),
						array(
							'type' => 'textbox',
							'name' => 'quote_link',
                ...
                array(
                    ...
                    'controls' => array(
						...
						array(
							...
							'description' => __( 'Enter the Copyright Text.', BUNCH_NAME ),
							'default' => 'Copyrights &copy; 2017 All Rights Reserved.'
						),
						array(
                            'type' => 'toggle',
                            'name' => 'hide_footer_nav',
