<?php fortun_bunch_global_variable(); 
	...
	$layout = fortun_set( $settings, 'author_page_layout', 'right' );
	$sidebar = fortun_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = fortun_set( $settings, 'author_page_view', 'list' );
	...
	$bg = (fortun_set($settings, 'author_page_header_img')) ? fortun_set($settings, 'author_page_header_img') : get_template_directory_uri().'/images/background/1.jpg';
	$title = fortun_set($settings, 'author_page_header_title');
?>
